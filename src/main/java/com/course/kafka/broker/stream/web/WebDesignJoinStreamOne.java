...
@Configuration
public class WebDesignJoinStreamOne
{
    @Bean
                                                                 ...
                                                                 WebLayoutVoteTimestampExtractor layoutVoteTimestampExtractor)
    {
        ...
        KTable<String, String> colorTable = streamsBuilder.table("t.commodity.web.vote-one-username-color",
        ...
        KTable<String, String> layoutTable = streamsBuilder.table("t.commodity.web.vote-one-username-layout",
                                                                     Consumed.with(stringSerde, stringSerde));
        ...
        colorLayoutVoteJoin.toStream().to("t.commodity.web.vote-one-result");
